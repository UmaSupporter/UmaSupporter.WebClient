...
const SupportCardComponent: React.FC<Props> = (props: Props) => {
  ...
  return (
    <div
      ...
      />
      <div className={"SupportCardLikeButton"}onClick={(e) => {e.stopPropagation(); props.onDoubleClickItem(uuid)}}>
        <svg className={`SupportCardLikeIcon ${props.selected?"liked":""}`} viewBox="0 0 32 32">
